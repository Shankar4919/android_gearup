        ...
        children: [
          Row(
            children: [
              ...
              Container(
                child: const TextGearUp(text: 'My Cart', fontSize: 24, fontWeight: FontWeight.w600 )
              ),
            ],
          ),
          ...
          Container(
            child: BlocBuilder<ProductBloc, ProductState>(
              builder: (_, state) 
              => state.products != null
              ? TextGearUp(text: '${state.products!.length} items', fontSize: 19, color: Colors.black54 )
              : TextGearUp(text: '0 items', fontSize: 19, color: Colors.black54 )
            )
          ),
        ],
      ),
